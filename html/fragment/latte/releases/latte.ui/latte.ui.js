...
(function (latte) {
    ...
    var UiElement = (function () {
         ...
         * @param useCapture
         */
        UiElement.prototype.addEventListener = function (event, f, useCapture) {
         ...
         * @param condition
         */
        UiElement.prototype.ensureClass = function (className, condition) {
            if (condition) {
...
(function (latte) {
    ...
    var View = (function (_super) {
        ...
        Object.defineProperty(View.prototype, "load", {
            /**
        ...
        Object.defineProperty(View.prototype, "shown", {
            /**
        ...
        Object.defineProperty(View.prototype, "unload", {
            /**
        ...
        Object.defineProperty(View.prototype, "unsavedChangesChanged", {
            /**
        ...
        Object.defineProperty(View.prototype, "savingChanges", {
            /**
        ...
        Object.defineProperty(View.prototype, "savedChanges", {
            /**
        ...
        View.prototype.saveChanges = function () {
            ...
            if (this.onSavingChanges() != false) {
                ...
                if (this['onSaveChanges']) {
                    ...
                    var m = latte['Message'].sendCalls(this.getSaveCalls());
                    m.responseArrived.add(function () { return _this.onSavedChanges(); });
                }
            }
        };
        /**
         ...
         */
        View.prototype.getSaveCalls = function () {
            var calls = [];
            // Concat all calls
            this.saveItems.each(function (item) { return calls = calls.concat(item.getSaveCalls()); });
            return calls;
        };
        /**
         * SPECIAL SETTER
         ...
         */
        View.prototype.updateSavedChanges = function () {
            var changes = false;
        ...
        Object.defineProperty(View.prototype, "saveItems", {
            /**
            ...
            get: function () {
                var _this = this;
                if (!this._saveItems) {
                    this._saveItems = new latte.Collection(function (item) {
                        item.unsavedChangesChanged.add(function () {
                            if (_this.saveItems.contains(item)) {
                                // log("unsavedChangesChanged! Checking")
                                // log(item)
                                _this.updateSavedChanges();
                            }
                        });
                    });
                }
...
(function (latte) {
    ...
    var ValueItem = (function (_super) {
         ...
         * @returns {String}
         */
        ValueItem.prototype.onGetValueString = function () {
        ...
        Object.defineProperty(ValueItem.prototype, "valueChanged", {
            /**
...
(function (latte) {
    ...
    var IconItem = (function (_super) {
        ...
        Object.defineProperty(IconItem, "defaultUrl", {
            //region Static
            /**
    ...
    var ButtonItem = (function (_super) {
        ...
        ButtonItem.prototype.showItems = function (side, edge) {
            ...
            menu.closed.add(function () {
                latte.ZIndex.removeElement(_this.element);
                if (_this.split && !_this.faceVisible) {
                    _this.element.removeClass('with-face');
                }
            });
...
(function (latte) {
    ...
    var DialogView = (function (_super) {
         ...
         */
        DialogView.input = function (title, inputs, validate, save) {
            if (validate === void 0) { validate = null; }
            if (save === void 0) { save = null; }
            var d = new DialogView();
            var f = new latte.FormView();
            var items = {};
            var values = function () {
                var r = {};
                for (var i in items) {
            ...
            d.addCancelButton(function () {
                cancelled = true;
            });
            d.closing.add(function () {
                if (cancelled) {
                    return true;
                }
                var valid = null;
                ...
                if (latte._isFunction(valid)) {
                    // Execute validation
                    d.enabled = false;
                    valid(function (validationResult) {
                        d.enabled = true;
        ...
        DialogView.prototype.onEnabledChanged = function () {
            _super.prototype.onEnabledChanged.call(this);
...
(function (latte) {
    ...
    var Glyph = (function (_super) {
        ...
        Object.defineProperty(Glyph, "defaultUrl", {
            /**
...
(function (latte) {
    ...
    var SeparatorItem = (function (_super) {
         ...
         */
        SeparatorItem.withTab = function (tab) {
...
(function (latte) {
    ...
    var FormItem = (function (_super) {
         ...
         * the save itself.
         */
        FormItem.prototype.getSaveCalls = function () {
            return [];
        };
        /**
         ...
         */
        FormItem.prototype.onDirectionChanged = function () {
         ...
         */
        FormItem.prototype.onReadOnlyChanged = function () {
         ...
         */
        FormItem.prototype.onUnsavedChangesChanged = function () {
            if (this._unsavedChangesChanged) {
                this._unsavedChangesChanged.raise();
            }
        };
        ...
        Object.defineProperty(FormItem.prototype, "directionChanged", {
            /**
        ...
        Object.defineProperty(FormItem.prototype, "readOnlyChanged", {
            /**
        ...
        Object.defineProperty(FormItem.prototype, "unsavedChangesChanged", {
            /**
        ...
        Object.defineProperty(FormItem.prototype, "direction", {
            /**
        ...
        Object.defineProperty(FormItem.prototype, "inputs", {
            /**
            ...
            get: function () {
                var _this = this;
                if (!this._inputs) {
                    this._inputs = new latte.Collection(function (input) {
                        _this.items.add(input);
                        input.valueChanged.add(function () { return _this.onValueChanged(); });
                        if (_this.direction) {
                            input.direction = _this.direction;
                        }
                        if (input.readOnly === null && _this.readOnly !== null) {
                            input.readOnly = _this.readOnly;
                        }
                        input.textVisible = true;
                    }, function (input) {
                        _this.items.remove(input);
                    });
                }
                return this._inputs;
            },
        ...
        Object.defineProperty(FormItem.prototype, "isValid", {
            /**
        ...
        Object.defineProperty(FormItem.prototype, "unsavedChanges", {
            /**
        ...
        Object.defineProperty(FormItem.prototype, "titleLabel", {
            /**
...
(function (latte) {
    ...
    var CheckboxItem = (function (_super) {
         ...
         * Override.
         */
        CheckboxItem.prototype.onValueChanged = function () {
         ...
         * Override
         */
        CheckboxItem.prototype.serialize = function () {
            return this.value ? "1" : "0";
        };
        /**
         * Override
         */
        CheckboxItem.prototype.unserialize = function (value) {
            this.value = !!parseInt(value);
        };
        ...
        Object.defineProperty(CheckboxItem.prototype, "label", {
            /**
...
(function (latte) {
    ...
    var DatePickerItem = (function (_super) {
         ...
         * Override.
         */
        DatePickerItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
            if (this.value) {
         ...
         * @param date
         */
        DatePickerItem.prototype.setValueSilently = function (date) {
            ...
            get: function () {
                ...
                if (!this._dateItem) {
                    ...
                    this._dateItem.selectionChanged.add(function () {
                        ...
                        _this.setValueSilently(_this.date);
                    });
                }
...
(function (latte) {
    ...
    var ComboItem = (function (_super) {
         ...
         * @returns {any}
         */
        ComboItem.prototype.onGetValueString = function () {
            var item;
         ...
         * Override.
         */
        ComboItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
...
(function (latte) {
     ...
     *
     */
    var FlagsValueItem = (function (_super) {
        __extends(FlagsValueItem, _super);
        //endregion
        /**
         *
         */
        function FlagsValueItem() {
            _super.call(this);
            //region Static
            //endregion
            //region Fields
        ...
        //region Private Methods
        FlagsValueItem.prototype.updateChecks = function () {
        ...
        FlagsValueItem.prototype.updateValue = function () {
         ...
         * Override.
         */
        FlagsValueItem.prototype.onGetValueString = function () {
            var list = [];
            var f = this.value;
         ...
         */
        FlagsValueItem.prototype.onOptionsChanged = function () {
            var _this = this;
            ...
            this.checks.clear();
            for (var i in this.options) {
                var check = new latte.CheckboxItem();
                check.label.text = this.options[i];
                check.tag = i;
                check.valueChanged.add(function () { return _this.updateValue(); });
         ...
         * Raises the <c>value</c> event
         */
        FlagsValueItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
        ...
        Object.defineProperty(FlagsValueItem.prototype, "optionsChanged", {
            /**
        ...
        Object.defineProperty(FlagsValueItem.prototype, "checks", {
            /**
             * Gets the checkboxes
             *
            ...
            get: function () {
                ...
                if (!this._checks) {
                    ...
                    // Add
                    function (check) {
                        _this.stack.items.add(check);
                    }, 
                    // Remove
                    // Remove
                    function (check) {
                        _this.stack.items.remove(check);
                    });
                }
                return this._checks;
            },
        ...
        Object.defineProperty(FlagsValueItem.prototype, "options", {
            /**
            ...
            set: function (value) {
                // Check if value changed
                var changed = value !== this._options;
                // Set value
                this._options = value;
                // Trigger changed event
                if (changed) {
        ...
        Object.defineProperty(FlagsValueItem.prototype, "stack", {
            /**
...
(function (latte) {
    ...
    var HtmlEditorItem = (function (_super) {
        ...
        Object.defineProperty(HtmlEditorItem, "rangyPath", {
            /**
        ...
        Object.defineProperty(HtmlEditorItem.prototype, "selectionChanged", {
            /**
        ...
        Object.defineProperty(HtmlEditorItem.prototype, "imageSelected", {
            /**
...
(function (latte) {
    ...
    var LabelValueItem = (function (_super) {
         ...
         * Override.
         */
        LabelValueItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
...
(function (latte) {
    ...
    var InputItem = (function (_super) {
         ...
         * @param name
         */
        InputItem.fromIInput = function (input, name, value) {
            if (name === void 0) { name = null; }
            if (value === void 0) { value = null; }
            var item = new InputItem(input.text || '(no text)', input.type || 'string', value || input.defaultValue || null, input.readOnly || null, name);
            item.name = name;
            if (input.options) {
         ...
         * @returns {string}
         */
        InputItem.prototype.onGetValueString = function () {
            if (this.valueItem) {
                return this.valueItem.valueString;
            }
            else {
                return _super.prototype.onGetValueString.call(this);
            }
        };
        /**
         * Override
         ...
         */
        InputItem.prototype.onValidChanged = function () {
         ...
         * @param hint
         */
        InputItem.prototype.setHint = function (hint) {
            if (hint) {
                var l = new latte.LabelItem(hint);
                this.hintItem = l;
            }
            else {
                this.hintItem = null;
        ...
        Object.defineProperty(InputItem.prototype, "validChanged", {
            /**
        ...
        Object.defineProperty(InputItem.prototype, "hintItem", {
            /**
        ...
        Object.defineProperty(InputItem.prototype, "valid", {
            /**
...
(function (latte) {
    ...
    var ProgressItem = (function (_super) {
         ...
         * Override.
         */
        ProgressItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
            var value = this.value;
...
(function (latte) {
    ...
    var RadioGroup = (function (_super) {
         ...
         **/
        RadioGroup.prototype.onGetValueString = function () {
...
(function (latte) {
     ...
     *
     */
    var SwitchItem = (function (_super) {
        __extends(SwitchItem, _super);
        //region Static
        //endregion
        //region Fields
        //endregion
         ...
         * Override.
         */
        SwitchItem.prototype.onGetValueString = function () {
            return this.value ? strings.switchOn : strings.switchOff;
        };
        /**
         * Override.
         */
        SwitchItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
            var value = this.value;
            if (!latte._isBoolean(value) && latte._isString(value) && latte._isNumeric(value)) {
                this.value = !!parseInt(value);
         ...
         * Override
         */
        SwitchItem.prototype.serialize = function () {
            return this.value ? "1" : "0";
        };
        /**
         * Override
         */
        SwitchItem.prototype.unserialize = function (value) {
            this.value = !!parseInt(value);
        };
        Object.defineProperty(SwitchItem.prototype, "orb", {
            /**
    ...
    var TextboxItem = (function (_super) {
        ...
        TextboxItem.prototype._updateInput = function () {
            ...
            this.input.keydown(function (evt) {
                ...
                _this.setValueSilently(_this.input.val());
         ...
         * @param value
         */
        TextboxItem.prototype.setValueSilently = function (value) {
            this.ignorePassToTextbox = true;
            this.value = value;
        };
        Object.defineProperty(TextboxItem.prototype, "enterPressed", {
            /**
        ...
        Object.defineProperty(TextboxItem.prototype, "keyUp", {
            /**
        ...
        Object.defineProperty(TextboxItem.prototype, "filterSuggestions", {
            /**
        ...
        Object.defineProperty(TextboxItem.prototype, "placeholderLabel", {
            /**
            ...
            get: function () {
                ...
                if (!this._placeholderLabel) {
                    ...
                    this._placeholderLabel.addEventListener('click', function () { return _this.input.focus(); });
        ...
        Object.defineProperty(TextboxItem.prototype, "sideLabel", {
            /**
             * Gets the side label
             *
             * @returns {LabelItem}
...
(function (latte) {
    ...
    var TimePickerItem = (function (_super) {
         ...
         * @returns {string}
         */
        TimePickerItem.prototype.zeroPad = function (i) {
            return i < 10 ? '0' + i : i.toString();
        };
        //endregion
        //region Methods
         ...
         * Override.
         */
        TimePickerItem.prototype.onValueChanged = function () {
            _super.prototype.onValueChanged.call(this);
            if (this.ignorePassToCombos) {
                this.ignorePassToCombos = false;
            }
         ...
         * @returns {String}
         */
        TimePickerItem.prototype.onGetValueString = function () {
            return String(this.value);
        };
        /**
         ...
         * @param hours
         */
        TimePickerItem.prototype.setHourSilently = function (hours) {
         ...
         * @param minutes
         */
        TimePickerItem.prototype.setMinuteSilently = function (minutes) {
         ...
         * @param seconds
         */
        TimePickerItem.prototype.setSecondSilently = function (seconds) {
         ...
         * @param value
         */
        TimePickerItem.prototype.setValueSilently = function (value) {
            this.ignorePassToCombos = true;
            this.value = value;
        };
        Object.defineProperty(TimePickerItem.prototype, "hourCombo", {
            /**
             * Gets the hour combo item
             *
             * @returns {ComboItem}
            ...
            get: function () {
                ...
                if (!this._hourCombo) {
                    this._hourCombo = new latte.ComboItem();
                    this._hourCombo.valueChanged.add(function () { return _this.setHourSilently(_this.hourCombo.value); });
                    this._hourCombo.button.loadItems.add(function () {
                        var hours = [];
                        for (var i = 0; i <= 23; i++) {
                            hours[i] = _this.zeroPad(i);
        ...
        Object.defineProperty(TimePickerItem.prototype, "minuteCombo", {
            /**
             * Gets the minutes combo Item
             *
             * @returns {ComboItem}
            ...
            get: function () {
                ...
                if (!this._minuteCombo) {
                    this._minuteCombo = new latte.ComboItem();
                    this._minuteCombo.valueChanged.add(function () { return _this.setMinuteSilently(_this.minuteCombo.value); });
                    this._minuteCombo.button.loadItems.add(function () {
                        var minutes = [];
                        for (var i = 0; i <= 59; i++) {
                            minutes[i] = _this.zeroPad(i);
        ...
        Object.defineProperty(TimePickerItem.prototype, "secondCombo", {
            /**
            ...
            get: function () {
                ...
                if (!this._secondCombo) {
                    ...
                    this._secondCombo.valueChanged.add(function () { return _this.setSecondSilently(_this.secondCombo.value); });
                    this._secondCombo.button.loadItems.add(function () {
                        var minutes = [];
                        for (var i = 0; i <= 59; i++) {
                            minutes[i] = _this.zeroPad(i);
                        }
                        _this._secondCombo.options = minutes;
                    });
    ...
    var ListView = (function (_super) {
        ...
        function ListView() {
            ...
            var words = function () { var r = ''; for (var i = 0; i < Math.random() * 8; i++)
                r += word() + ' '; return r; };
            this.element.get(0).addEventListener('keydown', function (e) {
        ...
        ListView.prototype.selectNextItem = function () {
            var index = this.selectedItem ? this.items.indexOf(this.selectedItem) : -1;
            index++;
...
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/View.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/values/ValueItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/overlays/Overlay.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/composites/ItemStack.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/selectables/SelectableItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/anchor/AnchorView.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/layout/SplitView.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/base/IconItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/clickables/ClickableItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/labels/LabelItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/clickables/ButtonGroupItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/clickables/ButtonItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/composites/Toolbar.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/selectables/SelectableLabel.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/overlays/StackOverlay.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/layout/ColumnView.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/layout/DialogView.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/navigation/NavigationView.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/Navigation.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/Action.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/ZIndex.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/base/ColorIconItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/base/Glyph.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/base/ImageItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/base/SeparatorItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/clickables/TabItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/composites/ColorPicker.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/clickables/PaginationItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/composites/ConversationItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/composites/FormItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/composites/DateItem.ts" />
...
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/selectables/CalendarItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/selectables/ListViewItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/values/CheckboxItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/selectables/TreeItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/values/ColorValueItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/values/DatePickerItem.ts" />
...
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/values/HtmlEditorCommands.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/items/values/HtmlEditorItem.ts" />
...
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/anchor/RibbonView.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/overlays/SuggestionOverlay.ts" />
/// <reference path="/Users/josemanuel/Sites/Fragment/latte/latte.ui/ts/latte.ui/views/anchor/TabView.ts" />
