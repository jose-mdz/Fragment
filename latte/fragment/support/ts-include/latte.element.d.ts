...
declare module latte {
    ...
    class Element<T extends HTMLElement> {
         ...
         */
        static readonly body: Element<HTMLBodyElement>;
        /**
         * Gets the scrollTop
         * @returns {number}
         */
        static readonly windowScrollLeft: number;
        /**
         * Gets the scrollTop
         * @returns {number}
         */
        static readonly windowScrollTop: number;
        private dataElements;
        /**
         * Creates an element
         */
        constructor(element?: HTMLElement);
        private addBindedElement;
        /**
         * Adds an element
         * @param element
         */
         ...
         * @param object
         */
        removeBindedElement(object: any): void;
        /**
         ...
         * @returns {LatteEvent}
         */
        readonly contentEditableChanged: LatteEvent;
        /**
         * Back field for event
         */
         ...
         * @returns {LatteEvent}
         */
        readonly dataBindAdded: LatteEvent;
        /**
         * Back field for event
         */
         ...
         * @returns {LatteEvent}
         */
        readonly eventBindAdded: LatteEvent;
        /**
         * Back field for event
         */
        private _tagChanged;
         ...
         * @returns {LatteEvent}
         */
        readonly tagChanged: LatteEvent;
        /**
         * Back field for event
         */
         ...
         * @returns {LatteEvent}
         */
        readonly visibleChanged: LatteEvent;
        /**
        ...
        */
         ...
         */
        readonly bindedElements: Element<HTMLElement>[];
        /**
         * Property field
         */
...
declare module latte {
    ...
    class LocalEditor {
         ...
         */
        static onClick(element: HTMLElement, edited?: () => void, cancelled?: () => void, finished?: () => void): LocalEditor;
        private _editingValue;
        private _editEventsAdded;
        private _oldTitle;
        /**
         * Creates the editor
         */
        constructor(element: HTMLElement, edited?: () => void, cancelled?: () => void, finished?: () => void);
        /**
         ...
         * Ends Edition Mode
         */
        endEditMode(success?: boolean): void;
        /**
         ...
         * @returns {LatteEvent}
         */
        readonly enabledChanged: LatteEvent;
        /**
...
declare module latte {
    ...
    class Textbox extends Element<HTMLInputElement> {
        ...
        */
         ...
         * @returns {LatteEvent}
         */
        readonly pristineChanged: LatteEvent;
        /**
...
declare module latte {
    ...
    class DataBind {
        ...
        */
         ...
         * @returns {string}
         */
        readonly elementProperty: string;
        /**
         * Property field
         */
        private _record;
         ...
         * @returns {string}
         */
        readonly recordProperty: string;
        /**
         * Property field
         */
        private _type;
