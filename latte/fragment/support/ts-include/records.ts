module latte{
		...
		set idsetting(value: number){
			let changed: boolean = value !== this._idsetting
		...
		**/
		...
		set idowner(value: number){
			let changed: boolean = value !== this._idowner
			this._idowner = value;
		...
		set owner(value: string){
			let changed: boolean = value !== this._owner
			this._owner = value;
		...
		set name(value: string){
			let changed: boolean = value !== this._name
			this._name = value;
		...
		**/
		onGetFieldTypes(): any { return {'idsetting': 'number', 'idowner': 'number', 'owner': 'string', 'name': 'string', 'value': 'string'}; }
 ...
 Search pageTag method
		...
		static byOwnerAndText(owner: string, text: string): RemoteCall<Setting[]>{
			return new RemoteCall<Setting[]>('fragment', 'Setting', 'byOwnerAndText', {owner: owner, text: text} );
		}
		...
		static byOwnerOnly(owner: string, id: number): RemoteCall<Setting[]>{
			return new RemoteCall<Setting[]>('fragment', 'Setting', 'byOwnerOnly', {owner: owner, id: id} );
		}
 ...
 Creates the pageTag for the specified record
		...
		static create(owner: string, id: number, value: string): RemoteCall<Setting>{
			return new RemoteCall<Setting>('fragment', 'Setting', 'create', {owner: owner, id: id, value: value} );
		}
 ...
 Gets the global settings of the app
		...
		static getGlobal(name: string): RemoteCall<Setting>{
			return new RemoteCall<Setting>('fragment', 'Setting', 'getGlobal', {name: name} );
		}
 ...
 Gets the global settings of the app
		...
		static getGlobals(): RemoteCall<Setting[]>{
			return new RemoteCall<Setting[]>('fragment', 'Setting', 'getGlobals', {} );
		}
 ...
 Gets the global setting by name. Only for root users
		...
		static getGlobalByName(name: string): RemoteCall<Setting>{
			return new RemoteCall<Setting>('fragment', 'Setting', 'getGlobalByName', {name: name} );
		}
		...
		static getGlobalConfigurableSettings(): RemoteCall<IGlobalConfigSettings>{
			return new RemoteCall<IGlobalConfigSettings>('fragment', 'Setting', 'getGlobalConfigurableSettings', {} );
		}
	}
	...
	export class fileBase extends DataRecord{
		...
		set idfile(value: number){
			let changed: boolean = value !== this._idfile
			this._idfile = value;
		...
		**/
		...
		set guid(value: string){
			let changed: boolean = value !== this._guid
			this._guid = value;
		...
		set iduser(value: number){
			let changed: boolean = value !== this._iduser
			this._iduser = value;
		...
		set idparent(value: number){
			let changed: boolean = value !== this._idparent
		...
		set bucket(value: string){
			let changed: boolean = value !== this._bucket
			this._bucket = value;
		...
		set path(value: string){
			let changed: boolean = value !== this._path
			this._path = value;
		...
		set uploaded(value: DateTime){
			let changed: boolean = value !== this._uploaded
		...
		set description(value: string){
			let changed: boolean = value !== this._description
		...
		set height(value: number){
			let changed: boolean = value !== this._height
			this._height = value;
		...
		set key(value: string){
			let changed: boolean = value !== this._key
			this._key = value;
		...
		* Override. Gets data about the type of fields of the record.
		**/
		onGetFieldTypes(): any { return {'idfile': 'number', 'guid': 'string', 'iduser': 'number', 'idowner': 'number', 'idparent': 'number', 'owner': 'string', 'name': 'string', 'size': 'number', 'bucket': 'string', 'path': 'string', 'uploaded': 'DateTime', 'description': 'string', 'width': 'number', 'height': 'number', 'key': 'string'}; }
 ...
 Deletes the children of the file
		...
		deleteChildren(): RemoteCall<any>{
			return new RemoteCall<any>('fragment', 'File', 'deleteChildren', {} , this.recordId);
		}
 ...
 Removes the registry of file and its contents from S3.
	...
	export class pageBase extends DataRecord{
		...
		set idpage(value: number){
			let changed: boolean = value !== this._idpage
			this._idpage = value;
		...
		**/
		...
		set idgroup(value: number){
			let changed: boolean = value !== this._idgroup
			this._idgroup = value;
		...
		set trash(value: boolean){
			let changed: boolean = value !== this._trash
			this._trash = value;
		...
		set online(value: boolean){
			let changed: boolean = value !== this._online
			this._online = value;
		...
		set template(value: string){
			let changed: boolean = value !== this._template
		...
		set created(value: DateTime){
			let changed: boolean = value !== this._created
			this._created = value;
		...
		set modified(value: DateTime){
			let changed: boolean = value !== this._modified
		...
		set title(value: string){
			let changed: boolean = value !== this._title
			this._title = value;
		...
		set order(value: number){
			let changed: boolean = value !== this._order
			this._order = value;
		...
		set sort(value: string){
			let changed: boolean = value !== this._sort
			this._sort = value;
		...
		set powner(value: number){
			let changed: boolean = value !== this._powner
			this._powner = value;
		...
		set pgroup(value: number){
			let changed: boolean = value !== this._pgroup
			this._pgroup = value;
		...
		set pother(value: number){
			let changed: boolean = value !== this._pother
			this._pother = value;
		...
		set pworld(value: number){
			let changed: boolean = value !== this._pworld
			this._pworld = value;
		...
		set flags(value: number){
			let changed: boolean = value !== this._flags
			this._flags = value;
		...
		* Override. Gets data about the type of fields of the record.
		**/
		onGetFieldTypes(): any { return {'idpage': 'number', 'idparent': 'number', 'idgroup': 'number', 'iduser': 'number', 'guid': 'string', 'key': 'string', 'trash': 'boolean', 'online': 'boolean', 'template': 'string', 'created': 'DateTime', 'modified': 'DateTime', 'title': 'string', 'description': 'string', 'order': 'number', 'sort': 'string', 'powner': 'number', 'pgroup': 'number', 'pother': 'number', 'pworld': 'number', 'flags': 'number'}; }
 ...
 Gets the settings of the page, including the parent ones.
		...
		getSettingsPack(): RemoteCall<IPageSettingsPack>{
			return new RemoteCall<IPageSettingsPack>('fragment', 'Page', 'getSettingsPack', {} , this.recordId);
		}
 ...
 Sends the page to trash
	...
	export class groupUserBase extends DataRecord{
		...
		set idgroupuser(value: number){
			let changed: boolean = value !== this._idgroupuser
		...
		* Override. Gets data about the type of fields of the record.
		**/
		onGetFieldTypes(): any { return {'idgroupuser': 'number', 'idgroup': 'number', 'iduser': 'number'}; }
	...
	export class fragmentBase extends DataRecord{
		...
		set idfragment(value: number){
			let changed: boolean = value !== this._idfragment
		...
		* Override. Gets data about the type of fields of the record.
		**/
		onGetFieldTypes(): any { return {'idfragment': 'number', 'idpage': 'number', 'value': 'string', 'name': 'string'}; }
	...
	export class groupBase extends DataRecord{
		...
		* Override. Gets data about the type of fields of the record.
		**/
		onGetFieldTypes(): any { return {'idgroup': 'number', 'name': 'string'}; }
	...
	export class userBase extends DataRecord{
		...
		**/
		...
		set uname(value: string){
			let changed: boolean = value !== this._uname
			this._uname = value;
		...
		set password(value: string){
			let changed: boolean = value !== this._password
		...
		* Override. Gets data about the type of fields of the record.
		**/
		onGetFieldTypes(): any { return {'iduser': 'number', 'uname': 'string', 'password': 'string', 'flags': 'number'}; }
 ...
 Returns a value indicating if the parent folder of fragment can be written
		...
		static canWriteHtAccess(): RemoteCall<any>{
			return new RemoteCall<any>('fragment', 'Server', 'canWriteHtAccess', {} );
		}
 ...
 Checks if there is a current valid connection with a database
		...
		static checkConnectionOk(): RemoteCall<boolean>{
			return new RemoteCall<boolean>('fragment', 'Server', 'checkConnectionOk', {} );
		}
 ...
 Checks if server can write on fragment folder
		...
		static checkFragmentFolderWritable(): RemoteCall<boolean>{
			return new RemoteCall<boolean>('fragment', 'Server', 'checkFragmentFolderWritable', {} );
		}
 ...
 Returns a value indicating if the database has no tables
		...
		static isDatabaseEmpty(): RemoteCall<boolean>{
			return new RemoteCall<boolean>('fragment', 'Server', 'isDatabaseEmpty', {} );
		}
 ...
 Returns a valude indicating if the .htaccess on root is present
		...
		static isHtAccessPresent(): RemoteCall<boolean>{
			return new RemoteCall<boolean>('fragment', 'Server', 'isHtAccessPresent', {} );
		}
 ...
 Checks if mod_rewrite is enabled
		...
		static checkModRewriteEnabled(): RemoteCall<number>{
			return new RemoteCall<number>('fragment', 'Server', 'checkModRewriteEnabled', {} );
		}
 ...
 Returns the source of the htaccess that should be present on installation
		...
		static getHtAccessSource(): RemoteCall<any>{
			return new RemoteCall<any>('fragment', 'Server', 'getHtAccessSource', {} );
		}
 ...
 Installs the database included in installer
		...
		static installDatabase(): RemoteCall<string>{
			return new RemoteCall<string>('fragment', 'Server', 'installDatabase', {} );
		}
 ...
 Copies the htaccess to the
		...
		static installHtAccess(): RemoteCall<number|boolean>{
			return new RemoteCall<number|boolean>('fragment', 'Server', 'installHtAccess', {} );
		}
 ...
 Adds records for an initial database
		...
		static installInitialRecords(rootPassword: any): RemoteCall<string>{
			return new RemoteCall<string>('fragment', 'Server', 'installInitialRecords', {rootPassword: rootPassword} );
		}
 ...
 Saves the specified connection parameters
		...
		static saveConnectionParameters(user: string, pass: string, db: string, host: string, lang: string): RemoteCall<string>{
			return new RemoteCall<string>('fragment', 'Server', 'saveConnectionParameters', {user: user, pass: pass, db: db, host: host, lang: lang} );
		}
 ...
 Changes the temporary language (used for install wizard)
		...
		static setTemporaryLang(lang: string): RemoteCall<any>{
			return new RemoteCall<any>('fragment', 'Server', 'setTemporaryLang', {lang: lang} );
		}
	}
